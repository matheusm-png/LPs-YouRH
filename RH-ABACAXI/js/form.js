...
(function () {
  ...
  var errorMessages = {
    ...
    pessoas_rh:   'Selecione o tamanho do seu time de RH.',
    desafio:      'Selecione seu maior desafio de RH.',
  ...
  function init() {
    ...
    var destination = form.getAttribute('action') || 'https://lp.yourh.com.br/rh-abacaxi/obrigado.html';
