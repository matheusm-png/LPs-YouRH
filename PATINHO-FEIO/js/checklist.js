...
(function () {
  ...
  var GROUPS = [
    {
      id:    'grupo1',
      label: '[PREENCHER: nome do grupo 1]',
      total: 3,
      lacuna: '[PREENCHER: lacuna genérica do grupo 1 — o que falta neste pilar]',
    },
    {
      id:    'grupo2',
      label: '[PREENCHER: nome do grupo 2]',
      total: 3,
      lacuna: '[PREENCHER: lacuna genérica do grupo 2]',
    },
    {
      id:    'grupo3',
      label: '[PREENCHER: nome do grupo 3]',
      total: 4,
      lacuna: '[PREENCHER: lacuna genérica do grupo 3]',
    },
  ];
  ...
  var RISK_LEVELS = [
    {
      range: [0, 3],
      type:  'danger',
      title: '[PREENCHER: mensagem de risco alto, ex: "Risco alto: sua empresa precisa agir agora"]',
      cta:   '[PREENCHER: CTA de risco alto, ex: "Quero resolver isso agora"]',
    },
    {
      range: [4, 6],
      type:  'warning',
      title: '[PREENCHER: mensagem de risco moderado, ex: "Risco moderado: há lacunas importantes a corrigir"]',
      cta:   '[PREENCHER: CTA de risco moderado, ex: "Revisar com um especialista"]',
    },
    {
      range: [7, 9],
      type:  'warning',
      title: '[PREENCHER: mensagem quase lá, ex: "Quase lá, mas ainda há pontos em aberto"]',
      cta:   '[PREENCHER: CTA quase lá, ex: "Validar os pontos restantes"]',
    },
    {
      range: [10, 10],
      type:  'ok',
      title: '[PREENCHER: mensagem de cobertura completa, ex: "Cobertura completa. Vale confirmar com especialista."]',
      cta:   '[PREENCHER: CTA cobertura completa, ex: "Confirmar com especialista"]',
    },
  ];
