  ...
  var GROUPS = [
    {
      ...
      total: 3,
      lacuna: 'Seu processo seletivo opera sem centralização: riscos de perda de candidatos e decisões de contratação mal documentadas.',
    },
    {
      id:    'grupo2',
      label: 'Avaliação de Desempenho',
      total: 3,
      lacuna: 'Suas avaliações de desempenho não estão estruturadas na plataforma: dados de performance ficam dispersos e sem efeito nas decisões.',
    },
    {
      id:    'grupo3',
      label: 'Treinamento & Desenvolvimento',
      total: 4,
      lacuna: 'Seu T&D não está vinculado às lacunas identificadas nas avaliações — treinamentos genéricos com impacto limitado.',
    },
  ];
  ...
  var RISK_LEVELS = [
    {
      range: [0, 3],
      type:  'danger',
      title: 'Gestão crítica — sua empresa opera com alto risco de perder talentos e tomar decisões com informação incompleta.',
      cta:   'Quero resolver isso agora',
    },
    {
      range: [4, 6],
      type:  'warning',
      title: 'Risco moderado — há lacunas importantes que afetam a qualidade das decisões de RH.',
      cta:   'Revisar com um especialista',
    },
    {
      range: [7, 9],
      type:  'warning',
      title: 'Quase lá — faltam poucos pontos para uma gestão 360° real e integrada.',
      cta:   'Validar os pontos restantes',
    },
    {
      range: [10, 10],
      type:  'ok',
      title: 'Boa cobertura! Vale validar com um especialista YouRH se a integração entre as ferramentas é de fato completa.',
      cta:   'Confirmar com especialista YouRH',
    },
  ];
